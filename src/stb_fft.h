...
STB_STATIC stb_fft_plan *stb_fft_plan_dft_1d(int N);

STB_STATIC stb_fft_real_plan *stb_fft_real_plan_dft_1d(int N);

STB_STATIC void stb_fft_r2c_exec(const stb_fft_real_plan *plan, const stb_real_t *in, cmplx *out);

STB_STATIC void stb_fft_c2r_exec(const stb_fft_real_plan *plan, const cmplx *in, stb_real_t *out);

STB_STATIC void stb_fft_exec(const stb_fft_plan *plan, const cmplx *in, cmplx *out);

STB_STATIC void stb_ifft_exec(const stb_fft_plan *plan, const cmplx *in, cmplx *out);

// for easily usage
STB_STATIC void STB_FFT(const cmplx *input, cmplx *output, int n);

STB_STATIC void STB_IFFT(const cmplx *input, cmplx *output, int n);

STB_STATIC void STB_FFT_R2C(const stb_real_t *input, cmplx *output, int n);

STB_STATIC void STB_IFFT_C2R(const cmplx *input, stb_real_t *output, int n);
...
STB_STATIC void stbSinCos(double x, stb_real_t *pSin, stb_real_t *pCos) {
    *pSin = (stb_real_t) sin(x);
    *pCos = (stb_real_t) cos(x);
}

STB_STATIC void stb_make_twiddles(int n, int count, cmplx *twiddles) {
...
STB_STATIC int stb_make_twiddles_sequential(int n, cmplx *twiddles, stb_fft_stages *stages) {
    int size = 0;
    {
        int offset = 0;
...
STB_STATIC stb_stage_info stb_calculate_stages(int n, stb_fft_plan *plan) {
    int calc_twiddles = 0;
    int stage = 0;
    int twiddles_size = 0;
    while (n > 1) {
...
STB_STATIC int stb_make_fft_plan(int N, stb_fft_plan *plan) {
    if (N == 0)
        return 0;
...
STB_STATIC void stb_general_dit(cmplx *twiddles, cmplx *out, int count,
...
STB_STATIC void stb_radix_2_dit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
...
STB_STATIC void stb_radix_3_dit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
    stb_real_t T1 = out[0].real;
...
STB_STATIC void stb_radix_4_dit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
...
STB_STATIC void stb_radix_5_dit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
    stb_real_t T1 = out[0].real;
...
STB_STATIC void stb_radix_6_dit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
...
STB_STATIC void stb_radix_7_dit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
    stb_real_t T1 = out[0].real;
...
STB_STATIC void stb_radix_8_dit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
...
STB_STATIC void stb_radix_2_idit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
    stb_real_t T1 = out[0].real;
    stb_real_t T2 = out[count].real;
...
STB_STATIC void stb_radix_3_idit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
    stb_real_t T1 = out[0].real;
...
STB_STATIC void stb_radix_4_idit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
    stb_real_t T2 = out[2 * count].real;
    stb_real_t T3 = out[0].real + T2;
...
STB_STATIC void stb_radix_5_idit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
    stb_real_t T1 = out[0].real;
...
STB_STATIC void stb_radix_6_idit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
    stb_real_t T2 = out[3 * count].real;
    stb_real_t T3 = out[0].real - T2;
...
STB_STATIC void stb_radix_7_idit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
    stb_real_t T1 = out[0].real;
...
STB_STATIC void stb_radix_8_idit(const cmplx *tw, cmplx *out, int count) {
    int m;
    cmplx *output;
    stb_real_t T2 = out[4 * count].real;
    stb_real_t T3 = out[0].real + T2;
...
STB_STATIC void stb_recursive_mixed_radix_dit(const stb_fft_plan *plan, int stage, const cmplx *in, cmplx *out, int sign) {
...
STB_STATIC void stb_recursive_mixed_radix_idit(const stb_fft_plan *plan, int stage, const cmplx *in, cmplx *out, int sign) {
    const int radix = plan->stages.radix[stage];
    const int count = plan->stages.remainder[stage];
    cmplx *twiddles = plan->twiddles;
    const int tw_offset = plan->stages.offsets[stage];
...
STB_STATIC void stb_fft_r2c_exec(const stb_fft_real_plan *plan, const stb_real_t *input, cmplx *output) {
...
STB_STATIC void stb_fft_c2r_exec(const stb_fft_real_plan *plan, const cmplx *input, stb_real_t *output) {
    int n = plan->half_plan->N;
